...
Per-change notes for the GroupDocs.Conversion.Mcp integration tests repo, captured
...
id: 001
date: 2026-04-23
package-under-test: 26.5.0   # version of GroupDocs.Conversion.Mcp the suite targets
...
`package-under-test` field records which `GroupDocs.Conversion.Mcp` version the

...
/// Boots the published GroupDocs.Conversion.Mcp NuGet via `dnx` as a child process,
...
public sealed class McpServerFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        var packageSpec = PackageVersion.IsLatest
            ...
            : $"GroupDocs.Conversion.Mcp@{PackageVersion.Value}";

        var transport = new StdioClientTransport(new StdioClientTransportOptions
        {
            Name = "groupdocs-conversion-mcp",
    ...
    private Dictionary<string, string?> BuildServerEnv()
    {
        ...
        // Forward license path if present — drops watermarks from converted output.

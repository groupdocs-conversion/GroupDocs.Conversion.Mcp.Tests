...
```bash
docker pull ghcr.io/groupdocs-conversion/conversion-net-mcp:26.7.0   # pinned to exact version
...
(
  ...
  sleep 2
    ...
    -v $(pwd)/documents:/data \
    ghcr.io/groupdocs-conversion/conversion-net-mcp:26.7.0 2>/dev/null
```
...
services:
  groupdocs-conversion-mcp:
    image: ghcr.io/groupdocs-conversion/conversion-net-mcp:26.7.0
    stdin_open: true
    tty: false
    environment:
...
docker inspect ghcr.io/groupdocs-conversion/conversion-net-mcp:26.7.0 \

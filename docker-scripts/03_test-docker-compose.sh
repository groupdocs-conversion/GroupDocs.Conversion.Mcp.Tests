#!/bin/bash
################################################################################
# GroupDocs.Conversion.Mcp — Docker-Compose Integration Test Runner
#
...
#   ./03_test-docker-compose.sh --version 26.5.2
#   ./03_test-docker-compose.sh --filter Convert --keep
#
################################################################################
...
services:
  test-runner:
    ...
    working_dir: /workspace/src/GroupDocs.Conversion.Mcp.Tests
    environment:
      DOTNET_NOLOGO: "true"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Conversion.Mcp — Docker Test Runner      ║"
    echo "╚════════════════════════════════════════════════════╝"
    echo ""

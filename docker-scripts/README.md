...
./02_test-all-scenarios.sh --version 26.5.2
...
Options:
  --version VERSION       Test specific package version (default: latest)
                          ...
                          stable release. Pin (e.g. "26.5.2") for reproducible
                          / shared / CI runs.
...
Examples:
  ...
  # Pin to 26.5.2 with custom license
  ./02_test-all-scenarios.sh --version 26.5.2 --license /path/to/lic
...
```bash
for version in 26.4.3 26.5.2 26.5.2 latest; do

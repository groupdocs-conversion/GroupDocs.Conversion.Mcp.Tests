#!/bin/bash
################################################################################
# GroupDocs.Conversion.Mcp — Integration Test Runner (local)
#
...
#   - Convert (DOCX/PDF/XLSX/PNG conversions across formats)
#   - GetSupportedFormats (possible-target enumeration per source)
#   - GetDocumentInfo (file type, page count, properties)
...
#                           most recent stable release. Pin (e.g. "26.5.2") for
#                           reproducible / shared / CI runs.
#   --filter PATTERN        Run only tests matching pattern (e.g., Convert)
...
#   ./02_test-all-scenarios.sh --version 26.5.2 --filter Convert
...
TEST_PROJECT_DIR="$PROJECT_ROOT/src/GroupDocs.Conversion.Mcp.Tests"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Conversion.Mcp — Integration Test Runner (local) ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    echo ""
